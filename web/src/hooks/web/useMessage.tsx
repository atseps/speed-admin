...
//响应接口的通知
function responseNotice(response: ResponseBody, duration = 1.5) {
  const noticeType: NoticeType = response.code == 1 ? "success" : "error";
  return message[noticeType](response.msg, duration);
}
