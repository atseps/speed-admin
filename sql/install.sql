...
-- ----------------------------
BEGIN;
INSERT INTO `speed_user` (`id`, `username`, `password`, `realname`, `pinyin`, `phone`, `email`, `dept_id`, `status`, `create_time`, `avatar`, `last_login_time`, `last_login_ip`, `is_admin`) VALUES (1, 'admin', '$2y$10$5h6kQoCpGd6aNbDwQcxMouUA1GBAHYSkpSm.EsghEubpT5khwN4Ye', 'super', '', '18899996666', '', 4, 1, 1748939339, '', 1750173840, '', 1);
